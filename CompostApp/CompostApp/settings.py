"""
Django settings for CompostApp project.
...
SECRET_KEY = 'django-insecure-v=lraj)_y9lj^lx(-r@r!32upgq^-k1yiph1(do$yf(h5zxz+e'
...
WSGI_APPLICATION = 'CompostApp.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, "CompostApp/static"),
     '/var/www/static/',
)
#TEMPLATE_DIRS = (
